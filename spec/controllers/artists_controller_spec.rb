...
RSpec.describe ArtistsController, type: :controller do
  ...
  describe "GET #edit" do
    it "assigns the artist-to-edit as @artist and renders the edit template" do
      artist = create(:artist)
  ...
  describe "PUT #update" do
    context "with valid params" do
      it "updates the requested artist" do
        artist = create(:artist)
        put :update, params: {:id => artist.to_param, :artist => attributes_for(:artist, name: "whatever")}
        artist.reload
        expect(artist.name).to eq("whatever")
      end
